...
RUN wget -O stremio-web.tar.gz https://github.com/Stremio/stremio-web/releases/download/v4.4.168/stremio-web-v4.4.168.tar.gz && tar -xzf stremio-web.tar.gz && rm stremio-web.tar.gz && mv build /app/stremio-web

RUN git clone –depth 1 https://github.com/ProjectSkill/stremio-community-v5 /app/addon && cd /app/addon && npm install && npm run build
